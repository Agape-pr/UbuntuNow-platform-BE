...
RESEND_FROM_EMAIL = os.getenv("RESEND_FROM_EMAIL", "support@ubuntunow.rw")
RESEND_FROM_NAME = os.getenv("RESEND_FROM_NAME", "UbuntuNow")
RESEND_TEMPLATE_OTP_ID = os.getenv("RESEND_TEMPLATE_ID")
